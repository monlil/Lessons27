...
public class test {
    public static void main(String[] args) { //  Урок 42: Метод equals() и String Pool.
       ...
       String string2 = "Hello";
        ...
        // Потоэму что при создании строки она ссылается на обьект "Hello" и при создании второй строки
        ...
        // string2 тоже ссылается на созданный обьект -> Hello1. Поэтому получается при сравнении true
